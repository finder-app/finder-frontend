...
goog.exportSymbol('proto.pb.SkipReq', null, global);
/**
 ...
 * @constructor
 */
proto.pb.SkipReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.SkipReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.SkipReq.displayName = 'proto.pb.SkipReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.pb.SkipReq.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.SkipReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.SkipReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.SkipReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    sentUserUid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    recievedUserUid: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.SkipReq}
 */
proto.pb.SkipReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.SkipReq;
  return proto.pb.SkipReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.SkipReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.SkipReq}
 */
proto.pb.SkipReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.SkipReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.SkipReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.SkipReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.SkipReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSentUserUid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.pb.SkipReq.prototype.getSentUserUid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pb.SkipReq} returns this
 */
proto.pb.SkipReq.prototype.setSentUserUid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pb.SkipReq.prototype.getRecievedUserUid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pb.SkipReq} returns this
 */
proto.pb.SkipReq.prototype.setRecievedUserUid = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
proto.pb.ConsentLikeRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    like: (f = msg.getLike()) && proto.pb.Like.toObject(includeInstance, f),
    room: (f = msg.getRoom()) && proto.pb.Like.toObject(includeInstance, f)
  };
...
/**
 * optional Like room = 2;
 * @return {?proto.pb.Like}
 */
proto.pb.ConsentLikeRes.prototype.getRoom = function() {
  return /** @type{?proto.pb.Like} */ (
    jspb.Message.getWrapperField(this, proto.pb.Like, 2));
};
